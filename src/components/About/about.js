...
export default function About() {
    return (
        <section id="about">
            ...
            <p className='about__bio'>Hello, my name is Cesar Feliciano and I'm a recent graduate of Brainstation's 
            ...
            has brought us, I was able to explore a fascination I didn't think 
            ...
            my passion and curiosity for tech, so during my free time I like to watch
